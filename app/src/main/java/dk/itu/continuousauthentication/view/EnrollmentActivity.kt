...
class EnrollmentActivity : AppCompatActivity(), Observer {
    ...
    private val EXTRA_NAME = "dk.itu.continuousauthentication.view.name"
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        getSupportActionBar()?.setBackgroundDrawable( ColorDrawable(resources.getColor(R.color.purple_200)))
